...
void Cmd_Whereami_f(const idCmdArgs& args) {
	...
	gameLocal.Printf("Current position is: (%f,%f,%f)", origin.x, origin.y, origin.z);
}
...
// squirrel: Mode-agnostic buymenus
	...
	cmdSystem->AddCommand("whereami",				Cmd_Whereami_f,				CMD_FL_GAME,				"Display current location");
// RITUAL END
